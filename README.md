...
<h3 align="center"> 
    Telegram Userbot Written In Python Using Pyrogram.
</h3>
...
<p align="center">
    ...
    <a href="https://GitHub.com/FadRepo">
...
<p align="center">
    ...
    <a href="https://t.me/xdazher"> XDazHer </a> | 
    <a href="https://t.me/amwang"> AMANG </a>
</p>
...
```console
ubuntu:~$ git clone https://github.com/FadRepo/PyroDaz
ubuntu:~$ cd PyroDaz
ubuntu:~$ pip3 install -U -r requirements.txt
ubuntu:~$ bash start 
```
