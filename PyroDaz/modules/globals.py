...
from PyroDaz import *
from PyroDaz.helpers.adminHelpers import DEVS, WHITELIST
from PyroDaz.helpers.basic import edit_or_reply
from PyroDaz.helpers.PyroHelpers import get_ub_chats
from PyroDaz.utils import extract_user, extract_user_and_reason
...
def globals_init():
    try:
        ...
        sql = import_module("PyroDaz.helpers.SQL.gban_sql")
        sql2 = import_module("PyroDaz.helpers.SQL.gmute_sql")
