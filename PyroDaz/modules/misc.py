...
from PyroDaz.utils import s_paste
from PyroDaz import *

from .help import *


@Client.on_message(filters.command("limit", CMD_HANDLER) & filters.me)
...
@Client.on_message(filters.command(["webshot", "ss"], CMD_HANDLER) & filters.me)
...
@Client.on_message(filters.command("type", CMD_HANDLER) & filters.me)
...
@Client.on_message(filters.command(["directmessage", "dm"], CMD_HANDLER) & filters.me)
...
@Client.on_message(filters.command("duck", CMD_HANDLER) & filters.me)
...
@Client.on_message(filters.command("open", CMD_HANDLER) & filters.me)
...
@Client.on_message(filters.command(["tt", "tiktok", "ig", "sosmed"], CMD_HANDLER) & filters.me)
